  ...
  if (window.tinymce) {
    ...
    if (tinymces.length) {
      ...
      window.tinymce.init({
        ...
        content_style: ".mce-content-body { color: "
          .concat(utils.getColors().emphasis, "; background-color: ")
          ...
          window.tinyMCE.editors.forEach(function (el) {
            el.dom.addStyle(
              ".mce-content-body{color: "
                ...
                .concat(utils.getColor("tinymce-bg"), " !important;}")
            );
          });
        }
      });
...
var appCalendarInit = function appCalendarInit() {
  ...
  addEventModal &&
    addEventModal.addEventListener(Events.SHOWN_BS_MODAL, function (_ref14) {
